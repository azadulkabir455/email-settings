...
document.addEventListener('DOMContentLoaded', function() {
    var siddebar_collapsible_elems = document.querySelectorAll('.collapsible');
     M.Collapsible.init(siddebar_collapsible_elems);
  });
...
// top_bottom Scrollbar js
$(function(){
    $(".top-scroll-bar").scroll(function(){
        $(".bottom-scroll-bar")
                .scrollLeft($(".top-scroll-bar").scrollLeft());
    });
    $(".bottom-scroll-bar").scroll(function(){
        $(".top-scroll-bar")
                .scrollLeft($(".bottom-scroll-bar").scrollLeft());
    });
});
